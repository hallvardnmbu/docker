...
echo "Setting up VPN kill switch for JavaScript container..."
...
# Allow web server/development ports from Docker networks (for JavaScript development)
...
iptables -A INPUT -j LOG --log-prefix "JS-DROPPED INPUT: " --log-level 4
iptables -A OUTPUT -j LOG --log-prefix "JS-DROPPED OUTPUT: " --log-level 4

echo "VPN kill switch activated for JavaScript container - only VPN traffic allowed"